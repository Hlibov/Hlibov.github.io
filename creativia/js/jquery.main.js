...
function initLavaLampMenu() {
	jQuery('.header-menu .menu-list').lavalamp({
		easing: 'easeOutBack'
	});
}
...
// add class active on button click
jQuery('.filter-button-group').click(function(e) {
...
(function ($) {
	...
	$.fn.carousel = function (opt) {
		return this.each(function () {
			jQuery(this).data('Carousel', new Carousel($.extend(opt, {
				holder: this
			})));
		});
	};
